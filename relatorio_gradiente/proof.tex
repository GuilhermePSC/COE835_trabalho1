...
\end{equation}
%
é perfeitamente possível provar a limitação de $\tilde{\theta}$, $\varepsilon}/m$ e $\dot{\varepsilon}/m$ utilizando a mesma função de Lyapunov e um raciocínio de cálculo análogo ao da seção anterior.
