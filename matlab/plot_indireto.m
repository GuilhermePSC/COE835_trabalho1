...
name = strcat(changed_str,num2str(eval(strcat(changed_str,'1'))),changed_str,num2str(eval(strcat(changed_str,'1'))));
...
title(titleStr);
legend(par1,par2,'r',strcat('yp para',par1),strcat('yp para',par2),'Location','SouthEast');
